...
class ResNetDCT_Dynamic(nn.Module):
    """ResNet backbone.
    ...
    def __init__(self,
        ...
        super(ResNetDCT_Dynamic, self).__init__()
        ...
        # self.deconv_y = make_input_layer(type='conv', out_ch=86)
        # self.deconv_cb = make_input_layer(type='deconv', out_ch=85)
        # self.deconv_cr = make_input_layer(type='deconv', out_ch=85)
    ...
    def forward(self, dct_y, dct_cb, dct_cr):
        dct_y, dct_cb, dct_cr, inp_atten = self.input_GM(dct_y, dct_cb, dct_cr)
    ...
    def train(self, mode=True):
        super(ResNetDCT_Dynamic, self).train(mode)
        self._freeze_stages()
